...
/// <summary>
/// Unit tests for Group 2, Task 2.2 — IPluginAccessPolicy read/download decision matrix.
///
...
///
///   sealed class PluginAccessPolicy : IPluginAccessPolicy
///     Constructed with new PluginAccessPolicy() — no dependencies (pure)
///
...
public sealed class PluginAccessPolicyTests
{
    ...
    private static IPluginAccessPolicy MakePolicy() => new PluginAccessPolicy();
    ...
    {
        // Arrange
        IPluginAccessPolicy policy = MakePolicy();
