...
/// <summary>
/// Unit tests for Group 5 use-cases: UploadAddOnUseCase and PublishVersionUseCase.
///
...
///
///   IAddOnPublishingRepositoryPort
///     Task&lt;AddOnPublishResult&gt; CreatePluginWithInitialVersionAsync(
///         CreateAddOnCommand command, CancellationToken ct = default)
///     Task&lt;AddOnVersionPublishResult&gt; AddVersionAsync(
...
///
///   AddOnPublishResult (record)
///     Guid PluginId, string Version
///
///   AddOnVersionPublishResult (record)
...
///     Task&lt;AddOnPublishResult&gt; ExecuteAsync(
///         UploadAddOnCommand command, CancellationToken ct = default)
///
///   UploadAddOnCommand (record)
...
///         IPackageStoragePort storage,
///         IPackageReader packageReader)
///     Task&lt;AddOnVersionPublishResult&gt; ExecuteAsync(
...
///     StatusCode == 400
///
///   DuplicateAddOnNameException : ProblemDetailsException
...
///     StatusCode == 409
///
///   AddOnNotFoundForVersionException : ProblemDetailsException
...
public sealed class PluginPublishingUseCaseTests
{
    ...
    // =========================================================================
    // Helpers: build a valid UploadAddOnCommand
    // =========================================================================

    private static UploadAddOnCommand MakeUploadCommand(
    ...
    private static (
        IAddOnPublishingRepositoryPort repo,
        IPackageStoragePort storage,
        UploadAddOnUseCase useCase) BuildUploadUseCase(
        bool nameExists = false,
        AddOnPublishResult? publishResult = null)
    {
        ...
        publishResult ??= new AddOnPublishResult(Guid.NewGuid(), "1.0.0");
        repo.CreatePluginWithInitialVersionAsync(
                Arg.Any<CreateAddOnCommand>(),
                Arg.Any<CancellationToken>())
            .Returns(publishResult);

        UploadAddOnUseCase useCase = new(repo, storage, reader);
        ...
        AddOnVersionPublishResult? publishResult = null)
    {
        ...
        publishResult ??= new AddOnVersionPublishResult(Guid.NewGuid(), Guid.NewGuid(), "1.1.0");
    ...
    public async Task UploadPlugin_ValidPackageAndMetadata_Returns201WithPluginIdAndVersion()
    {
        ...
        AddOnPublishResult expected = new(expectedPluginId, "1.0.0");
        (_, _, UploadAddOnUseCase useCase) = BuildUploadUseCase(publishResult: expected);

        UploadAddOnCommand command = MakeUploadCommand();
    ...
    {
        // Arrange
        (_, IPackageStoragePort storage, UploadAddOnUseCase useCase) =
            BuildUploadUseCase();
    ...
    public async Task UploadPlugin_ValidPackage_PackageKeyFollowsConvention()
    {
        ...
        (_, IPackageStoragePort storage, UploadAddOnUseCase useCase) = BuildUploadUseCase();
        ...
        UploadAddOnCommand command = MakeUploadCommand(name: "MyPlugin", initialVersion: "1.0.0");
    ...
    public async Task UploadPlugin_ValidPackageWithReadme_ReadmeExtractedAndPassedToRepository()
    {
        ...
        (IAddOnPublishingRepositoryPort repo, _, UploadAddOnUseCase useCase) = BuildUploadUseCase();

        CreateAddOnCommand? capturedCommand = null;
        await repo.CreatePluginWithInitialVersionAsync(
            Arg.Do<CreateAddOnCommand>(c => capturedCommand = c),
            Arg.Any<CancellationToken>());
        repo.CreatePluginWithInitialVersionAsync(
                Arg.Any<CreateAddOnCommand>(),
                Arg.Any<CancellationToken>())
            .Returns(new AddOnPublishResult(Guid.NewGuid(), "1.0.0"));

        UploadAddOnCommand command = MakeUploadCommand(packageStream: archive);
    ...
    public async Task UploadPlugin_CreatesInitialVersionWithIsLatestTrue()
    {
        ...
        UploadAddOnCommand command = MakeUploadCommand(initialVersion: "1.0.0");
    ...
    public async Task UploadPlugin_CustomInitialVersion_AcceptsNonCanonical100()
    {
        ...
        AddOnPublishResult expected = new(Guid.NewGuid(), "2.5.3");
        (_, _, UploadAddOnUseCase useCase) = BuildUploadUseCase(publishResult: expected);
    ...
    public async Task UploadPlugin_NameNormalizedGeneratedAsLowerInvariant()
    {
        ...
        UploadAddOnCommand command = MakeUploadCommand(name: "MyAwesomePlugin");
    ...
    public async Task UploadPlugin_ReleaseNotesDefaultEmptyWhenNotProvided()
    {
        ...
        // Empty release notes
        UploadAddOnCommand command = MakeUploadCommand(releaseNotes: "");
    ...
    // =========================================================================
    // UploadAddOnUseCase — missing package file
    ...
    {
        // Arrange
        (_, _, UploadAddOnUseCase useCase) = BuildUploadUseCase();

        UploadAddOnCommand command = MakeUploadCommand(packageStream: new MemoryStream());
    ...
    // =========================================================================
    // UploadAddOnUseCase — missing required manifest field
    ...
    // =========================================================================
    // UploadAddOnUseCase — invalid semver in initialVersion
    ...
    // =========================================================================
    // UploadAddOnUseCase — duplicate plugin name
    ...
    public async Task UploadPlugin_DuplicateName_ThrowsDuplicatePluginNameException()
    {
        ...
        (_, _, UploadAddOnUseCase useCase) = BuildUploadUseCase(nameExists: true);

        UploadAddOnCommand command = MakeUploadCommand(name: "MyPlugin");

        // Act & Assert
        DuplicateAddOnNameException ex = await Assert.ThrowsAsync<DuplicateAddOnNameException>(
            () => useCase.ExecuteAsync(command));
    ...
    // =========================================================================
    // UploadAddOnUseCase — package format errors propagated from PackageReader
    ...
    public async Task PublishVersion_ValidNewVersion_Returns201WithVersionRecord()
    {
        ...
        AddOnVersionPublishResult expected = new(pluginId, Guid.NewGuid(), "1.1.0");
    ...
    public async Task PublishVersion_NewVersion_FlipsPriorIsLatest_CallsAddVersionAsync()
    {
        // Arrange
        Guid pluginId = Guid.NewGuid();
        (IAddOnPublishingRepositoryPort repo, _, PublishVersionUseCase useCase) =
    ...
    public async Task PublishVersion_NonExistentPlugin_ThrowsPluginNotFoundForVersionException()
    {
        ...
        // Act & Assert
        AddOnNotFoundForVersionException ex =
            await Assert.ThrowsAsync<AddOnNotFoundForVersionException>(
                () => useCase.ExecuteAsync(command));
