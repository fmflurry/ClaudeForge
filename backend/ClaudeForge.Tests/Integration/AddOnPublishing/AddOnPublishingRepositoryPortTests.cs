...
/// <summary>
/// Integration tests for Group 5: IAddOnPublishingRepositoryPort adapter.
///
...
///
///   ClaudeForge.Infrastructure.AddOnPublishing.AddOnPublishingRepositoryAdapter
///     AddOnPublishingRepositoryAdapter(MarketplaceDbContext context)
///     implements IAddOnPublishingRepositoryPort
///
///   ClaudeForge.Application.Modules.AddOnPublishing.Ports.IAddOnPublishingRepositoryPort
...
public sealed class PluginPublishingRepositoryPortTests : IAsyncLifetime
{
    ...
    // -------------------------------------------------------------------------
    // Helper: build a CreateAddOnCommand
    // -------------------------------------------------------------------------

    private static CreateAddOnCommand MakeCreateCommand(
    ...
    public async Task CreatePluginWithInitialVersionAsync_ValidCommand_PersistsPluginAndVersion()
    {
        // Arrange
        await using MarketplaceDbContext ctx = _fixture.CreateContext();
        IAddOnPublishingRepositoryPort repo = new AddOnPublishingRepositoryAdapter(ctx);
        CreateAddOnCommand command = MakeCreateCommand(name: "NewPlugin", version: "1.0.0");

        // Act
        AddOnPublishResult result = await repo.CreatePluginWithInitialVersionAsync(command);
        ...
        AddOnEntity? plugin = await verifyCtx.Plugins
        ...
        AddOnVersionEntity version = plugin.Versions.First();
    ...
    public async Task CreatePluginWithInitialVersionAsync_InitialVersionIsLatestTrue()
    {
        ...
        await using MarketplaceDbContext ctx = _fixture.CreateContext();
        IAddOnPublishingRepositoryPort repo = new AddOnPublishingRepositoryAdapter(ctx);
        CreateAddOnCommand command = MakeCreateCommand(name: "IsLatestPlugin", version: "1.0.0");
    ...
    public async Task CreatePluginWithInitialVersionAsync_WithReadme_PersistedToReadmeText()
    {
        ...
        await using MarketplaceDbContext ctx = _fixture.CreateContext();
        IAddOnPublishingRepositoryPort repo = new AddOnPublishingRepositoryAdapter(ctx);
        CreateAddOnCommand command = MakeCreateCommand(
            name: "ReadmePlugin",
            version: "1.0.0",
    ...
    public async Task CreatePluginWithInitialVersionAsync_NameNormalizedAndSlugPersisted()
    {
        ...
        await using MarketplaceDbContext ctx = _fixture.CreateContext();
        IAddOnPublishingRepositoryPort repo = new AddOnPublishingRepositoryAdapter(ctx);
        CreateAddOnCommand command = MakeCreateCommand(name: "MyPlugin") with
        {
        ...
        // Assert
        await using MarketplaceDbContext verifyCtx = _fixture.CreateContext();
        AddOnEntity? plugin = await verifyCtx.Plugins.FindAsync(result.PluginId);
    ...
    public async Task AddVersionAsync_NewVersion_FlipsPriorIsLatestToFalse()
    {
        ...
        await using MarketplaceDbContext ctx = _fixture.CreateContext();
        IAddOnPublishingRepositoryPort repo = new AddOnPublishingRepositoryAdapter(ctx);
        CreateAddOnCommand createCmd = MakeCreateCommand(name: "FlipPlugin", version: "1.0.0");
        AddOnPublishResult created = await repo.CreatePluginWithInitialVersionAsync(createCmd);

        // Act — add v1.1.0
        await using MarketplaceDbContext ctx2 = _fixture.CreateContext();
        IAddOnPublishingRepositoryPort repo2 = new AddOnPublishingRepositoryAdapter(ctx2);
        ...
        await using MarketplaceDbContext verifyCtx = _fixture.CreateContext();
        List<AddOnVersionEntity> versions = await verifyCtx.PluginVersions
            .Where(v => v.PluginId == created.PluginId)
            .ToListAsync();

        Assert.Equal(2, versions.Count);

        AddOnVersionEntity? v100 = versions.FirstOrDefault(v => v.Version == "1.0.0");
        AddOnVersionEntity? v110 = versions.FirstOrDefault(v => v.Version == "1.1.0");
    ...
    public async Task AddVersionAsync_MultipleVersions_OnlyOneIsLatestAtAllTimes()
    {
        ...
        await using MarketplaceDbContext ctx = _fixture.CreateContext();
        IAddOnPublishingRepositoryPort repo = new AddOnPublishingRepositoryAdapter(ctx);
        CreateAddOnCommand createCmd = MakeCreateCommand(name: "MultiVersionPlugin", version: "1.0.0");
        AddOnPublishResult created = await repo.CreatePluginWithInitialVersionAsync(createCmd);
        ...
        IAddOnPublishingRepositoryPort repo3 = new AddOnPublishingRepositoryAdapter(ctx3);
        ...
        AddOnVersionEntity? latest = versions.FirstOrDefault(v => v.IsLatest);
    ...
    public async Task AddVersionAsync_DuplicateVersion_ThrowsAtDatabaseLevel()
    {
        ...
        await using MarketplaceDbContext ctx = _fixture.CreateContext();
        IAddOnPublishingRepositoryPort repo = new AddOnPublishingRepositoryAdapter(ctx);
        CreateAddOnCommand createCmd = MakeCreateCommand(name: "DupVersionPlugin", version: "1.0.0");
        AddOnPublishResult created = await repo.CreatePluginWithInitialVersionAsync(createCmd);
    ...
    public async Task PluginExistsAsync_ExistingId_ReturnsTrue()
    {
        ...
        await using MarketplaceDbContext ctx = _fixture.CreateContext();
        IAddOnPublishingRepositoryPort repo = new AddOnPublishingRepositoryAdapter(ctx);
        AddOnPublishResult created = await repo.CreatePluginWithInitialVersionAsync(
    ...
    public async Task GetVersionHistoryAsync_WithMultipleVersions_ReturnsSemVerDesc()
    {
        ...
        IAddOnPublishingRepositoryPort repo4 = new AddOnPublishingRepositoryAdapter(ctx4);
    ...
    public async Task GetVersionHistoryAsync_IncludesDownloadCountPerVersion()
    {
        ...
        AddOnVersionEntity? v100 = await updateCtx.PluginVersions
            .FirstOrDefaultAsync(v => v.PluginId == created.PluginId && v.Version == "1.0.0");
        AddOnVersionEntity? v200 = await updateCtx.PluginVersions
        ...
        IAddOnPublishingRepositoryPort readRepo = new AddOnPublishingRepositoryAdapter(readCtx);
        (IReadOnlyList<VersionHistoryDto> items, _) =
    ...
    public async Task GetVersionHistoryAsync_Pagination_ReturnsPaginatedSubset()
    {
        ...
        foreach (string ver in new[] { "1.1.0", "1.2.0", "1.3.0", "1.4.0" })
        {
            ...
            IAddOnPublishingRepositoryPort addRepo = new AddOnPublishingRepositoryAdapter(addCtx);
    ...
    public async Task GetVersionAsync_ExistingVersion_ReturnsVersionDetail()
    {
        ...
        await using MarketplaceDbContext ctx = _fixture.CreateContext();
        IAddOnPublishingRepositoryPort repo = new AddOnPublishingRepositoryAdapter(ctx);
        CreateAddOnCommand createCmd = MakeCreateCommand(
