...
/// <summary>
/// Integration tests for Group 20 (tasks 20.1–20.2): AddOnDataSeeder.
///
/// These tests run against a REAL PostgreSQL 16 container via Testcontainers.
/// Docker must be running on the test host.
///
/// PACKAGE STORAGE DECISION: Metadata-only seeding. The AddOnDataSeeder inserts
...
///
///   Class:
///     AddOnDataSeeder : IAddOnDataSeeder
///       AddOnDataSeeder(MarketplaceDbContext context, ICategorySeeder categorySeeder)
///       Task SeedAsync(CancellationToken ct = default)
...
///     IReadOnlyList&lt;SeedAddOnDefinition&gt; AddOnDataSeeder.SeedDefinitions { get; }
///
///   SeedAddOnDefinition record:
///     string Name
///     string Slug
///     string Author
///     string Description
...
public sealed class PluginDataSeederTests : IAsyncLifetime
{
    ...
    // -------------------------------------------------------------------------
    // Helper: create a fully wired AddOnDataSeeder against the test container.
    // -------------------------------------------------------------------------

    private static IAddOnDataSeeder CreateSeeder(MarketplaceDbContext ctx)
    {
        ICategorySeeder categorySeeder = new CategorySeeder(ctx);
        return new AddOnDataSeeder(ctx, categorySeeder);
    }
    ...
    public async Task SeedAsync_InsertsExactlyTenPlugins()
    {
        // Arrange
        await using MarketplaceDbContext ctx = _fixture.CreateContext();
        IAddOnDataSeeder seeder = CreateSeeder(ctx);
    ...
    public async Task SeedAsync_PluginsHaveExpectedNamesAndSlugs()
    {
        ...
        IReadOnlyList<SeedAddOnDefinition> definitions = AddOnDataSeeder.SeedDefinitions;
        Assert.Equal(10, definitions.Count);

        foreach (SeedAddOnDefinition def in definitions)
        {
    ...
    public async Task SeedDefinitions_StaticList_HasExactlyTenEntries()
    {
        ...
        IReadOnlyList<SeedAddOnDefinition> defs = AddOnDataSeeder.SeedDefinitions;
    ...
    public async Task SeedAsync_MultiVersionPlugin_VersionsSemverAscending_MatchDefinition()
    {
        ...
        SeedAddOnDefinition multiVersionDef = AddOnDataSeeder.SeedDefinitions
    ...
    public async Task SeedAsync_MultiTypePlugin_DefinitionHasAtLeastTwoTypes()
    {
        ...
        SeedAddOnDefinition? multiTypeDef = AddOnDataSeeder.SeedDefinitions
            .FirstOrDefault(d => d.Types.Count >= 2);

        Assert.NotNull(multiTypeDef);
        Assert.True(multiTypeDef!.Types.Count >= 2,
            "At least one SeedAddOnDefinition must declare ≥2 types.");
    }
    ...
    public async Task SeedAsync_SeededPlugins_AllDefinedLanguagesArePresentInDb()
    {
        ...
        HashSet<string> expectedLanguages = AddOnDataSeeder.SeedDefinitions
    ...
    public async Task SeedAsync_SeededPlugins_AllDefinedTypesArePresentInDb()
    {
        ...
        HashSet<string> expectedTypes = AddOnDataSeeder.SeedDefinitions
    ...
    public async Task SeedAsync_SeededPlugins_AllDefinedUseCasesArePresentInDb()
    {
        ...
        HashSet<string> expectedUseCases = AddOnDataSeeder.SeedDefinitions
    ...
    // =========================================================================
    // Test 6a — Read side: ListAddOnsUseCase returns the 10 seeded plugins.
    // =========================================================================
    ...
    public async Task SeedAsync_AfterSeeding_ListPluginsUseCaseReturnsTen()
    {
        ...
        PaginatedEnvelope<AddOnSummaryDto> result = await useCase.ExecuteAsync(
            new ListAddOnsQuery { Page = 1, Limit = 20 });
    ...
    public async Task SeedAsync_AfterSeeding_ListPluginsUseCaseEnvelopeHasCorrectPaginationShape()
    {
        ...
        PaginatedEnvelope<AddOnSummaryDto> result = await useCase.ExecuteAsync(
            new ListAddOnsQuery { Page = 1, Limit = 5 });
    ...
    public async Task SeedAsync_AfterSeeding_ListPluginsUseCasePageTwoReturnsRemaining()
    {
        ...
        // Act
        PaginatedEnvelope<AddOnSummaryDto> page1 = await useCase.ExecuteAsync(
            new ListAddOnsQuery { Page = 1, Limit = 5 });
        PaginatedEnvelope<AddOnSummaryDto> page2 = await useCase.ExecuteAsync(
            new ListAddOnsQuery { Page = 2, Limit = 5 });
    ...
    public async Task SeedAsync_AfterSeeding_ListCategoriesUseCaseReturnsNonZeroCounts()
    {
        ...
        ICategoryRepositoryPort categoryRepo = new AddOnRepositoryAdapter(ctx);
    ...
    // =========================================================================
    // Test 6c — Read side: SearchAddOnsUseCase returns known seeded keyword hits.
    // =========================================================================
    ...
    public async Task SeedAsync_AfterSeeding_SearchReturnsMatchForKnownPluginKeyword()
    {
        ...
        SearchAddOnsUseCase searchUseCase = new(searchAdapter);

        // Act — search for "linter", which is a known word in the seeded plugin "TypeScript Linter"
        SearchAddOnsResult result = await searchUseCase.ExecuteAsync(
            new SearchAddOnsQuery { Q = "linter", Page = 1, Limit = 20 });
    ...
    public async Task SeedAsync_AfterSeeding_SearchReturnsMatchForSecondKnownKeyword()
    {
        ...
        SearchAddOnsResult result = await searchUseCase.ExecuteAsync(
            new SearchAddOnsQuery { Q = "security", Page = 1, Limit = 20 });
    ...
    public async Task SeedAsync_AfterSeeding_SearchWithTypeFilterReturnsSubsetOfSeeds()
    {
        ...
        IReadOnlyList<SeedAddOnDefinition> agentDefs = AddOnDataSeeder.SeedDefinitions
    ...
    public async Task SeedAsync_AfterSeeding_SearchForNonExistentTermReturnsEmptyWithSuggestions()
    {
        ...
        SearchAddOnsResult result = await searchUseCase.ExecuteAsync(
            new SearchAddOnsQuery { Q = "zzz_impossible_term_xyz", Page = 1, Limit = 20 });
    ...
    public async Task SeedAsync_EnsuresCategoryVocabExists_AllFifteenCategoryRowsPresent()
    {
        ...
        // Act — AddOnDataSeeder must call CategorySeeder internally
        await seeder.SeedAsync();
