...
///
/// Tests that DownloadAddOnUseCase (once wired with ICurrentUser + IOrgMembershipQueryPort +
/// IAddOnAccessPolicy) enforces the 404-read / 401-anonymous non-disclosure rule:
///
...
///   - DownloadAddOnUseCase gains (ICurrentUser, IOrgMembershipQueryPort, IAddOnAccessPolicy)
///   - IAddOnDistributionRepositoryPort.ResolveAsync returns plugin visibility + ownerOrgId
