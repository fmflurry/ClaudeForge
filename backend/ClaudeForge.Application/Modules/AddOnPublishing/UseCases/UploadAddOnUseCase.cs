...
using ICategoryLookupPort = ClaudeForge.Application.Modules.AddOnPublishing.Ports.ICategoryLookupPort;
...
/// </summary>
public sealed class UploadAddOnUseCase
{
        ...
        IPackageReader packageReader)
    {
        ...
        _accessPolicy = new AddOnAccessPolicy();
    }

    public async Task<AddOnPublishResult> ExecuteAsync(
        UploadAddOnCommand command,
        CancellationToken ct = default)
    {
        ...
        if (nameExists)
            throw new DuplicateAddOnNameException(command.Name);
        ...
        CreateAddOnCommand createCommand = new(
            Name: command.Name,
