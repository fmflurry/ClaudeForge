...
/// </summary>
public sealed class DiscoverAddOnsUseCase
{
    ...
    /// </summary>
    public DiscoverAddOnsUseCase(ISearchIndexPort index)
    {
        _index = index;
        _currentUser = null;
    ...
    public async Task<DiscoverAddOnsResult> ExecuteAsync(
        DiscoverAddOnsQuery query,
        CancellationToken ct = default)
    {
        ...
        return new DiscoverAddOnsResult
        {
            Items = sorted,
    ...
    private static IReadOnlyList<string> BuildCriteriaEcho(DiscoverAddOnsQuery query)
    {
        List<string> echoed = [];
