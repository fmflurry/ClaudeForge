...
namespace ClaudeForge.Infrastructure.AddOnDistribution;

/// <summary>
/// EF Core adapter implementing <see cref="IAddOnDistributionRepositoryPort"/>.
/// All counter increments use DB-side arithmetic (no read-modify-write) to be race-safe.
/// </summary>
public sealed class AddOnDistributionRepositoryAdapter : IAddOnDistributionRepositoryPort
{
    private readonly MarketplaceDbContext _context;

    public AddOnDistributionRepositoryAdapter(MarketplaceDbContext context)
    {
        _context = context;
    }
        ...
        CancellationToken ct = default)
    {
        ...
        AddOnEntity? pluginEntity = await _context.Plugins
            .AsNoTracking()
        ...
        // Resolve version row.
        AddOnVersionEntity? versionRow = version is null
