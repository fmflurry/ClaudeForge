...
///   2. For each <see cref="SeedAddOnDefinition"/> whose name_normalized is not already present,
...
/// </summary>
public sealed class AddOnDataSeeder : IAddOnDataSeeder
{
    ...
    // -------------------------------------------------------------------------
    public static IReadOnlyList<SeedAddOnDefinition> SeedDefinitions { get; } =
    [
        new SeedAddOnDefinition(
    ...
    public AddOnDataSeeder(MarketplaceDbContext context, ICategorySeeder categorySeeder)
    {
        _context = context;
    ...
    public async Task SeedAsync(CancellationToken ct = default)
    {
        ...
        {
            SeedAddOnDefinition def = SeedDefinitions[i];
        ...
        CancellationToken ct)
    {
        ...
        List<AddOnCategoryEntity> categoryAssociations = BuildCategoryAssociations(
    ...
    private static List<AddOnCategoryEntity> BuildCategoryAssociations(
        Guid pluginId,
        SeedAddOnDefinition def,
        List<CategoryEntity> allCategories)
    {
        List<AddOnCategoryEntity> associations = [];
        ...
        foreach (string typeValue in def.Types)
        {
            ...
            {
                associations.Add(new AddOnCategoryEntity
                {
                    PluginId = pluginId,
