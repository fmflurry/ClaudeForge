...
Defines the application's theming system: a yellow-forward brand palette expressed as semantic OKLCH tokens, complete light/dark palettes, theme selection and persistence, SSR flash-of-wrong-theme prevention, and WCAG 2.1 AA contrast compliance.
