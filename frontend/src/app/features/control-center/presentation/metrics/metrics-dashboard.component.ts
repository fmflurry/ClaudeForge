  ...
  template: `
    ...
    @if (facade.isLoading()) {
      ...
      <div class="stats-grid">
        <div class="stat-card"><h3>Analyzed</h3><p class="stat-value">{{ facade.analysisMetrics().totalAnalyzed }}</p></div>
        <div class="stat-card"><h3>Passed</h3><p class="stat-value">{{ facade.analysisMetrics().totalPassed }}</p></div>
        <div class="stat-card"><h3>Failed</h3><p class="stat-value">{{ facade.analysisMetrics().totalFailed }}</p></div>
        <div class="stat-card"><h3>In Review</h3><p class="stat-value">{{ facade.analysisMetrics().totalInReview }}</p></div>
      </div>
